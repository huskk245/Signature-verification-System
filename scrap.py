...
# Set the theme to "clam" for a clean modern look
style.theme_use("clam")

# Set the font for ttk widgets
...
uname_label = ttk.Label(root, text="Compare Two Signatures:")
uname_label.place(x=90, y=50)

img1_message = ttk.Label(root, text="Signature 1:")
